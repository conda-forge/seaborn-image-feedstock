...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/seaborn-image-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13615&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/seaborn-image-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `seaborn-image` can be installed with:

```
conda install seaborn-image
```

It is possible to list all of the versions of `seaborn-image` available on your platform with:
